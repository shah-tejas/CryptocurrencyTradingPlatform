...
export class WithdrawWalletComponent implements OnInit {
  ...
  // Update the values when user selects a coin from dropdown
  ...
  // Calculate and update the USD Value for the transaction
  updateUSDValue() {
    for (const coin of this.coins) {
  ...
  // Logic to submit the form and create the transactions
  submitWithdrawForm() {
  ...
  // Update the User's wallet after Withdraw
  updateUserWallet() {
