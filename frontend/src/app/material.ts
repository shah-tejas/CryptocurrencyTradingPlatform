...
@NgModule({
  imports: [MatNativeDateModule, MatTabsModule, MatDatepickerModule, MatIconModule,
    ...
    MatDialogModule, MatAutocompleteModule, MatSelectModule, MatGridListModule, MatProgressSpinnerModule],
  ...
  exports: [MatNativeDateModule, MatTabsModule,
    ...
    MatMenuModule, MatAutocompleteModule, MatProgressSpinnerModule],
